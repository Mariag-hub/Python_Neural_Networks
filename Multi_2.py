...
class MLP_2(object):
    ...
    def __init__(self, n_hidden1, n_hidden2, eta, mini_batch_size):
    ...
    def fit(self, X_train, y_train, X_test, y_test, epochs):
            ...
            with g1.as_default():
                ...
                h1 = tf.layers.dense(inputs=tf_x, units=self.n_hidden1,
                             activation=tf.tanh,
                             name='layer1')
                
                h2 = tf.layers.dense(inputs=h1, units = self.n_hidden2, 
